...
class EditInventoryForm extends React.Component {
    ...
    handleSubmit(e) {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                let inventory = {
                    "id": this.props.one_inventory.id,
                    ...
                    "added_by_user_name":this.props.one_inventory.added_by_user_name,
                    "updated_by_user_name":"",
                    "status": this.props.one_inventory.status,
                };
                invenrotyService.updateOneInvenroty(inventory).then(data => {
    ...
    render() {
        let one_inventory=this.props.one_inventory;
        ...
        const inventoryTypeSelector = getFieldDecorator('inventory_type_id', {
            initialValue: one_inventory.inventory_type_id,
        })(
            <Select>
                {type_select_options}
            </Select>
                ...
                <Form onSubmit={this.handleSubmit} style={{maxWidth: '800px'}}>
                    ...
                    >
                        {getFieldDecorator('inventory_id', {
                            ...
                            initialValue:one_inventory.inventory_id
                        })(
                            <Input disabled={true} placeholder={one_inventory.inventory_id}/>
                        )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                    ...
                    >
                        {getFieldDecorator('inventory_name', {
                            ...
                            initialValue:one_inventory.inventory_name
                        })(
                            <Input/>
                        )}
                    </FormItem>
                    ...
                    >
                        {getFieldDecorator('inventory_count', {
                            rules: [{
                                required: true, message: '请输入原料库存数量!',
                            }],
                            initialValue:one_inventory.inventory_count
                        })(
                            <Input placeholder={one_inventory.inventory_count}/>
                        )}
                    </FormItem>
                    <FormItem
                        {...formItemLayout}
                ...
                <Icon type="question-circle-o"/>
                    ...
                    >
                        {getFieldDecorator('inventory_unit', {
                            ...
                            initialValue:one_inventory.inventory_unit
                        })(
                            <Input/>
                        )}
                    </FormItem>
                    ...
                    >
                        {getFieldDecorator('description', {
                            rules: [],
                            initialValue:one_inventory.description
                        })(
                            <TextArea rows={4}/>
                        )}
                    </FormItem>
...
const WrappedEditInventoryForm = Form.create()(EditInventoryForm);

export default WrappedEditInventoryForm;
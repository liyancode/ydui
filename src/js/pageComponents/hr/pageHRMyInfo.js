                            ...
                            <div>
                                <div className="col-sm-12 col-md-4">
                                    ...
                                    <table className="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            <td>照片</td>
                                            <td><img src={"/public/assets/products_img/" + this.state.user['user_id'] + "/" + this.state.user['user_id'] + ".jpg"} style={{ width: 100 ,border:'solid 2px white'}}/>头像</td>
                                        </tr>
                                        <tr>
                                            <td>姓名</td>
                                ...
                                <div className="col-sm-12 col-md-4">
                                    ...
                                    <table className="table table-bordered table-condensed">
                                        ...
                                        <tr>
                                            <td>状态</td>
                                            <td>{
                                                this.state.user_employee_info["position_status"]==='normal'?
                                                    <Tag color="#87d068">正常在职</Tag>
                                                    :<Tag color="#f50">未知</Tag>
                                            }</td>
                                        </tr>
                                        <tr>
